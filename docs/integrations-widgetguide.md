...
---
## Introduction
The KyberWidget is a straightforward method for websites to setup and provide a friendly stock user interface for their users to perform 1 of the following functionalities:
1. Pay for goods with ERC20 tokens
2. Swap from one ERC20 token to another
3. Purchase a specific token
